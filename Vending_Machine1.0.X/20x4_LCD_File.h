...
#define RS LATC0                    /*PIN 0 of PORTB is assigned for register select Pin of LCD*/
#define EN LATC1                    /*PIN 1 of PORTB is assigned for enable Pin of LCD */
#define ldata LATC                  /*PORTB(PB4-PB7) is assigned for LCD Data Output*/ 
